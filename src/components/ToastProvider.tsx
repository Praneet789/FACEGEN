  ...
  return (
    <ToastContext.Provider value={{ toasts, show, dismiss }}>
      ...
      <div className="fixed z-50 top-4 right-4 flex flex-col gap-2 w-72">
        {toasts.map(t => (
          <div key={t.id} className={`pointer-events-auto px-4 py-3 rounded-xl shadow-soft backdrop-blur border text-sm flex items-start gap-3 animate-fade-in-up select-none
            ...
            ${t.type === 'info' ? 'bg-gray-900/85 text-white border-gray-700/60' : ''}`}> 
